  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="group w-[80vw] sm:w-[60vw] md:w-[45vw] lg:w-[35vw] xl:w-[25vw] max-w-full relative flex-shrink-0 rounded-2xl glass border-border hover:border-foreground/12 dark:border-white/[0.08] p-5 sm:p-6 md:p-8 lg:p-10 transition-all duration-300 hover:-translate-y-1 dark:hover:border-white/15 hover:bg-black/[0.03] dark:hover:bg-black/80 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.04),0_10px_25px_rgba(0,0,0,0.08)] dark:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.04),0_10px_25px_rgba(0,0,0,0.5)]"
            key={idx}
          >
            {/* Decorative glows */}
              ...
              <div className="mt-6 sm:mt-8">
                ...
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-base sm:text-lg font-semibold leading-tight text-text-primary font-display">
                      {item.name}
                    </span>
